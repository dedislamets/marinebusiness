                                            ...
                                            <div> 
                                                ...
                                                <div class="product-options-bottom">                        
                                                    ...
                                                    <div class="product-addto-links">
                                                       <a class="btn_df btnProduct" href="/account/login" title="Negotiation">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer"> 
        ...
        <div class="col-md-10">
            ...
            ?> 
            <a href="<?= base_url(); ?>setting/export_pdf/<?= $number ?>" id="btnAgreement" class="btn btn-primary" target="_blank" disabled>
                Agreement
            </a>
        </div>
      </div>
