                            ...
                            <div class="panel with-nav-tabs panel-default" style="margin-bottom:0 ">
                               <div class="panel-heading single-project-nav">
                                    <ul class="nav nav-tabs"> 
                                        <li class="active">
                                          <a href="#pengajuan_saya" data-toggle="tab">Pengajuan Saya</a>
                                        </li>
                                        <li>
                                          <a href="#pengajuan_client" data-toggle="tab">Request Pengajuan Client</a>
                                        </li>                                        
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="pengajuan_saya">
                                            <div class="form-group row">
                                                <label for="country" class="col-sm-3 col-form-label right" >No. Pengajuan</label>
                                                <div class="col-sm-9">
                                            ...
                                            <h3 style="background: darkgoldenrod;color: #fff;padding: 5px;margin-bottom: 0;">Langkah - langkah Sign Pengajuan</h3>  
                                            <ul style="padding: 10px;background-color: gainsboro;color: black;">
                                                <li>Download file Pdf sesuai Kode Pengajuan</li>
                                                <li>Cetak / print berwarna file Pdf yang sudah di download</li>
                                                <li>Berikan tanda tangan di atas materai</li>
                                                <li>Scan dokumen tersebut dan simpan dengan format JPEG,JPG atau PDF</li>
                                                <li>Upload Kembali pada halaman ini untuk menyelesaikan pengajuan</li>
                                                <li>Dokumen akan menunggu proses selanjutnya jika pihak I dan II telah selesai Sign</li>
                                            </ul>
                                        </div>
