                    ...
                    <div class="agent-info__identity">
                        ...
                        <div class="basic-info impression">
                            <h2 class="contact-large">
                                <a href="/agusriyadi2016" itemprop="name">User Login</a>
                            </h2>                            
                            <p name="lastActivity" class="contact-large">Aktif: Kurang dari 1 minggu</p>
                        </div>
                    </div>                    
                                                ...
                                                <div id="form-step-0" role="form" data-toggle="validator">    
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="Trading" <?php if($service == 'Trading') echo "checked"; ?>>
                                                                ...
                                                                <div class="form-check disabled">
                                                                    <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios4" value="Transportation">
                                                    ...
                                                    <div style="border: dotted;padding: 10px" class="charter <?php if($service!='Chartering') echo "hidden"; ?>">
                                                        <div class="form-group row dura">
                                                            <label for="price_charter" class="col-sm-3 col-form-label right" >Price</label>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="area" class="col-sm-3 col-form-label right" >Area Operational</label>
                                                            <div class="col-sm-9">
                                                    ...
                                                    <div style="border: dotted;padding: 10px" class="freight hidden">
                                                        <div class="form-group row">
                                                            <label for="loa" class="col-sm-3 col-form-label right">Price</label>
                                                            <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control angka" value="0" name="qty_freight" id="qty_freight" style="padding-right: 57px;">
                                                    ...
                                                    <div style="border: dotted;padding: 10px" class="csm hidden">
                                                        <div class="form-group row">
                                                            <label for="price_csm" class="col-sm-3 col-form-label right" >Price</label>
                                                            <div class="col-sm-9">
                                            ...
                                            <div id="step-2">
                                                ...
                                                <div id="form-step-1" role="form" data-toggle="validator">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="owner" id="owner" placeholder="Write Owners" value="<?= $owner ?>"  required>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="builder" id="builder" placeholder="Write Company" value="<?= $builder ?>" required>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                   ...
                                                   <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control angka" name="loa" id="loa" value="<?= $loa ?>" required style="padding-right: 57px;">
                                                            <div class="suffix">meters</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <label for="length" class="col-sm-1 col-form-label">Length:</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control angka" value="0" name="length" id="length" value="<?= $length ?>" required style="padding-right: 57px;">
                                                            <div class="suffix">meters</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control angka" name="breadth" id="breadth" value="<?= $breadth ?>" required style="padding-right: 57px;">
                                                            <div class="suffix">meters</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <label for="dept" class="col-sm-1 col-form-label">Dept Moulded:</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control angka" name="dept" id="dept" value="<?= $depth ?>" required style="padding-right: 57px;">
                                                            <div class="suffix">meters</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control angka" name="summer" id="summer" value="<?= $summer ?>" required style="padding-right: 57px;">
                                                            <div class="suffix">meters</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control right angka" value="<?= $sideboard ?>" name="side" id="side" required style="padding-right: 42px;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control right angka" value="<?= $deck_capacity ?>" name="desk2" id="desk2" required style="padding-right: 58px;">
                                                            <div class="suffix">Tonnes</div>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                        <label for="load" class="col-sm-2 col-form-label">Max Deck Load:</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control right angka" value="<?= $max_deck_load ?>" name="load" id="load" required style="padding-right: 68px;">
                                            ...
                                            <div id="step-3" class="">  
                                                ...
                                                <div id="form-step-2" role="form" data-toggle="validator">               
                                                    <div class="form-group row">
                                                     ...
                                                     <a href="javascript::void(0)" id="btnUp" name="btnUp" class="btn btn-secondary btn-sm">Simpan</a>                                                
