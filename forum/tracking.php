...
<body>
  ...
  <script>
    ...
    function initMap() {
      ...
      if (navigator.geolocation) {
        ...
        let watch = navigator.geolocation.watchPosition(showLocation, errorHandler, options);
  ...
  <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBszZ3A0R4_8Y0lBitLqNn7EhEfNw8u2-I&callback=initMap"></script>
</body>
</html>